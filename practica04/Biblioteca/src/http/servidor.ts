...
const repositorio = new InMemoryPrestamoRepository(); // Esta es la unica linea que se cambia si se desea pasar a Mongo o cualquier otro gestio de base de datos en un futuro
...
app.use(
	(
		...
		// El DTO venia bien pero choca con el sistema
...
// Si el frontend se encontrara en otro puerto (ej. puerto 80) deberia de agregarse el CORS aqui en el servidor
